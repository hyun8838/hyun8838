...
📩 Email: wjsgusdlf46@naver.com  
🐙 GitHub: [hyun8838](https://github.com/hyun8838)
...
- 🛒 **고객 데이터 · 구매 패턴 분석** (퍼널, 코호트, 재구매 분석)
- 📊 **데이터 시각화 · 대시보드** (운영 모니터링, 의사결정 지원 도구 구축)
- 🔍 **데이터 품질 검증** (파이프라인 검증, 불일치 패턴 분석)
